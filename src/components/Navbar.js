    ...
    <div>
        <nav id="navbar" className= {`navbar ${OuvertureNavigationBar ? "isVisible" : ""}`} >
            <ul className="navbar-nav">
                <li className="logo-nav-item">
                    ...
                    <svg style= {{margin:"0",width:"1px",minWidth:"0"}} width="1" height="39" viewBox="0 0 1 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line x1="0.25" y1="1.09278e-08" x2="0.249998" y2="39" stroke="white" stroke-width="0.5"/>
                    </svg>
                    <span id="link-text" className="link-text logo-nav-item">ASNIÈRES<br />VOLLEY BALL 92</span>
                    </Link>
                </li>
                ...
                <li className =  {`nav-item ${splitLocation[1] === "ProgramPage" ? "activeNavbar" : "nav-item"}`}>
        ...
        <div className= {`navbar ${OuvertureSubNavigationBarClub ? "isVisible_subNavbar" : ""}`} id = "subNavbarClub">
            ...
            <ul>
                ...
                <div id="ligne"></div>
                <li>
                    <Link to="/PlanningEntrainement">Planning des entraînements</Link>
                    <div>
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 13L7 7L0.999999 1" stroke="#2B3968" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
        ...
        <div className= {`navbar ${OuvertureSubNavigationBarInfo ? "isVisible_subNavbar" : ""}`} id = "subNavbarClub">
            ...
            <ul>
                ...
                <div id="ligne"></div>
                <li>
                    <Link to="/PlanAccesGymnase">Plan d’accès aux Gymnases</Link>
                    <div>
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 13L7 7L0.999999 1" stroke="#2B3968" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
        ...
        <div className= {`navbar ${OuvertureSubNavigationBarEquipe ? "isVisible_subNavbar" : ""}`} id = "subNavbarClub" style={{margin:"0",overflow:"scroll"}}>
            ...
            <ul>
                ...
                <div id="ligne"></div>
                <li onClick={() => Navbar()}>
                    <Link to="/EquipeSenior/Equipe_M15_M">M15 G CDF et Championnat Régional</Link>
                    <div>
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 13L7 7L0.999999 1" stroke="#2B3968" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                ...
                <div id="ligne"></div>
                <li onClick={() => Navbar()}>
                    <Link to="/EquipeSenior/Equipe_M13_F">M13 F CDF et Championnat Régional</Link>
                    <div>
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 13L7 7L0.999999 1" stroke="#2B3968" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                ...
                <div id="ligne"></div>
                <li onClick={() => Navbar()}>
                    <Link to="/EquipeSenior/Equipe_M13_M">M13 G CDF et Championnat Régional</Link>
                    <div>
                        <svg width="8" height="14" viewBox="0 0 8 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M1 13L7 7L0.999999 1" stroke="#2B3968" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
