                            ...
                            <div className="column1" >
                                <div className="row1">
                                    <div className="trainerPicture" >
                                        <img style= {{width:"2ç3px"}} src={"https://docs.google.com/uc?id="+"11bugfIEan1UsUuAdtJm7NhfzDQzchzoZ"}></img>
                                    </div>
                                </div>
                                <div className="row2">
                                    06 85 06 57 83
                                    ...
                                    <div className="column2">
                                        ...
                                        <div className="row2">
                                            ...
                                            <div className="training">
                                                <ul>
                                                    <li>LUNDI - 18H15-20H30</li>
                                                    <li>MERCREDI - 14H00-16H00</li>
                                                </ul>
                                            </div>

                                            <Link to="/EquipeSenior/Equipe_M13_M">
