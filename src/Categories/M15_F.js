...
import view_descartes from '../images/view_descartes.png'
                            ...
                            <div className="column2ManyPlaces" >
                                ...
                                <div className="row2" style={{padding:"15px"}}>
                                    ...
                                    <div className="training-card">
                                        <div className="maps" style = {{backgroundImage: "url(" + descartes + ")",backgroundSize: "90%"}} >
                                            <div className="streetview" style = {{backgroundImage: "url(" +view_descartes+ ")"}}>
                                    ...
                                    <Link to="/EquipeSenior/Equipe_M15_F">
