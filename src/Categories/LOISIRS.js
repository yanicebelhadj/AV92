                            ...
                            <div className="column2ManyPlaces" >
                                ...
                                <div className="row2" style={{padding:"15px"}}>
                                    ...
                                    <div className="training-card">
                                        <div className="maps" style = {{backgroundImage: "url(" + riner + ")",backgroundSize: "90%"}} >
                                            <div className="streetview" style = {{backgroundImage: "url(" +view_riner+ ")"}}>
