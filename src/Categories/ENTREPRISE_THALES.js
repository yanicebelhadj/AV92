...
import riner from '../images/riner.png'

import view_riner from '../images/view_riner.png'
                        ...
                        <div className = "OnePlace">
                            ...
                            <div className="column2" >
                                ...
                                <div className="row2" style={{padding:"15px"}}>
                                    <div className="column1" style = {{backgroundImage: "url(" +riner+ ")",backgroundSize:"200%",backgroundPosition:'80% center'}}>
                                        
                                    </div>
                                    <div className="column2">
                                        <div className="row1" style = {{backgroundImage: "url(" +view_riner+ ")",backgroundSize:"150%",backgroundPosition:'center center'}}>
...
export default ENTREPRISE_THALES;