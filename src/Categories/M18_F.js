                    ...
                    <div className="containerCard" >
                        ...
                        <div className = "OnePlace">
                            <div className="column1" >
                                <div className="row1">
                                    <div className="trainerPicture" >
                                        <img style= {{width:"293px"}} src={"https://docs.google.com/uc?id="+"1pgPmwWwI7ndRzhD8KxFJWc4cGagve_Ig"}></img>
                                    </div>
                                </div>
                                <div className="row2">
                                    06 11 08 62 67
                            ...
                            <div className="column2" >
                                <div className="row1" >
                                    <h1>WARGHLIS WOITIEE</h1>
                                    <h2>COACH M18 F</h2>
                                </div>
                                <div className="line"></div>
                                <div className="row2" style={{padding:"15px"}}>
                                    <div className="column1" style = {{backgroundImage: "url(" +renoir+ ")",backgroundSize:"200%",backgroundPosition:'80% center'}}>
                                        
                                    </div>
                                    <div className="column2">
                                        <div className="row1" style = {{backgroundImage: "url(" +view_renoir+ ")",backgroundSize:"150%",backgroundPosition:'center center'}}>
                                        ...
                                        <div className="row2">
                                            ...
                                            <div className="training">
                                                <ul>
                                                    <li>VENDREDI - 18H15-20H30</li>
                                                </ul>
                                            </div>

                                            <Link to="/EquipeSenior/Equipe_M18_F">
