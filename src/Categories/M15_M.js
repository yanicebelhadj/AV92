                            ...
                            <div className="column1" >
                                <div className="row1">
                                    <div className="trainerPicture" >
                                        <img style= {{width:"293px"}} src={"https://docs.google.com/uc?id="+"1FpOzATsJaoyHk5P65rF0ICzKQUe-itI-"}></img>
                                    </div>
                                </div>
                                <div className="row2">
                                    07 63 74 88 48
                                    ...
                                    <div className="column2">
                                        ...
                                        <div className="row2">
                                            ...
                                            <div className="training">
                                                <ul>
                                                    <li>MARDI - 18H15-20H30</li>
                                                    <li>VENDREDI - 18H15-20H30</li>
                                                </ul>
                                            </div>

                                            <Link to="/EquipeSenior/Equipe_M15_M">
